 ...
 * @author daniel
 */
public class PolarChartDemo extends javax.swing.JFrame {
    public PolarChart chart = new PolarChart();

    /**
     * Creates new form PolarChartDemo
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PolarChartDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        PolarChartDemo demo = new PolarChartDemo();
        demo.setTitle("Polar Chart Demo");
